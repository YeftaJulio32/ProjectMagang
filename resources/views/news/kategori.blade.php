                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb bg-transparent p-0">
                            <li class="breadcrumb-item">
                                <a href="{{ route('news.index') }}" class="text-decoration-none text-secondary-emphasis">
                                    <i class="bi bi-house-door"></i> Home
                                </a>
                            </li>
                            <li class="breadcrumb-item active text-decoration-none text-secondary-emphasis"
                                aria-current="page">
                                {{ ucfirst($kategori) }}
                            </li>
                        </ol>
    ...
    <div class="bg-body-tertiary border-top mt-5 py-4">
        <div class="container">
            ...
            <div class="d-flex flex-wrap gap-2">
                @php
                    // Buat slug dari kategori saat ini untuk perbandingan
                    $currentCategorySlug = \Illuminate\Support\Str::slug($kategori);
                @endphp
                ...
                @if (isset($availableCategories) && $availableCategories->count() > 0)
                    @foreach ($availableCategories as $cat)
                        ...
                        @endphp
                        @if ($catSlug !== $currentCategorySlug)
                            <a href="{{ route('news.kategori', $catSlug) }}"
